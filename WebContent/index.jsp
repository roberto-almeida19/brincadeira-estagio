	...
	<form method="post" action="./professor" accept-charset="iso-8859-1">
        ...
        <div class="form-control dados">
          ...
          <div class="form-check">
            <input class="form-check-input" name="cursos" type="checkbox" value="Análise e Desenvolvimento de Sistemas" id="defaultCheck1">
            <label class="form-check-label" for="defaultCheck1">Análise e Desenvolvimento de Sistemas </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" name="cursos" type="checkbox" value="Comércio Exterior" id="defaultCheck1">
            <label class="form-check-label" for="defaultCheck1">Comércio Exterior </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" name="cursos" type="checkbox" value="Logística" id="defaultCheck1">
            <label class="form-check-label" for="defaultCheck1">Logística </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" name="cursos" type="checkbox" value="Gestão Empresarial" id="defaultCheck1">
            <label class="form-check-label" for="defaultCheck1">Gestão Empresarial </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" name="cursos" type="checkbox" value="Polímeros" id="defaultCheck1">
